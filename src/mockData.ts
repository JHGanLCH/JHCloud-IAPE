...
export const mockDashboardStats: DashboardStats = {
  ...
  aiInsights: [
    ...
    },
    {
      ...
      subject: 'COMPREHENSIVE',
      period: 'MONTHLY',
      summary: '本月经营表现强劲。关键经营指标方面，月度营收达成率提升至108%，利润率稳步增长2.3%，订单交付率优化至97.2%。产品生产和交付方面，本月累计产出30台，成功交付26台，其中HMC系列卧式加工中心产出效率提升15%。紧急和重点任务方面，顺利完成“东南亚客户紧急插单”的快速交付，数字化工厂二期硬件招标工作已启动。重大质量问题方面，针对前期出现的“床身铸件砂眼”缺陷，通过引入超声波无损检测及优化浇筑工艺，本月缺陷率下降了40%。资源配套方面，数控系统芯片供应出现短期波动，已通过与发那科（FANUC）建立战略储备协议，确保了未来三个月的生产需求。',
      metrics: [
        { label: '月度营收达成', value: '108%', trend: 'UP', description: '较上月提升3.0%' },
        { label: '订单交付率', value: '97.2%', trend: 'UP', description: '创季度新高' },
        { label: '质量损失率', value: '0.9%', trend: 'DOWN', description: '下降0.3%' },
        { label: '库存周转率', value: '4.5', trend: 'UP', description: '物料流转效率提升' }
      ],
      alerts: [
        { type: 'WARNING', message: '下月预计受电力调配影响，需提前调整高能耗工序的排班计划。' },
        { type: 'INFO', message: '床身铸件质量改进方案已全面推行，本月抽检合格率提升至98.5%。' },
        { type: 'INFO', message: '数字化工厂二期硬件供应商入围名单已公示。' }
      ],
      suggestions: [
        '针对电力调配风险，建议将重型机加工序调整至夜间低谷时段。',
        '继续深化与核心芯片供应商的联动，建立多级预警机制。',
        '启动“质量月”专项活动，进一步巩固铸件质量改进成果。'
      ]
    },
    {
      id: 'comp-q-1',
